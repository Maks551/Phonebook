...
public class UserTestData {
    ...
    public static final User USER = new User(USER_ID, USER_LOGIN, "password1", "name1");
    public static final User USER_2 = new User(USER_ID + 1, "login2", "password2", "name2");
    public static final User USER_3 = new User(USER_ID + 2, "login3", "password3", "name3");
    ...
    public static User getCreated() {
        return new User(null, "CreatedUser", "CreatedPassword", "CreatedName");
    }
}
