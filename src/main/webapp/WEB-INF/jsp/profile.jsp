        ...
        <div class="row">
            <div class="col-5 offset-3">
                ...
                <form:form class="form-group" modelAttribute="userTo" method="post" action="${register ? 'register' : 'profile'}"
                    ...
                    <phonebook:inputField labelCode="user.name" name="name"/>
                    <phonebook:inputField labelCode="user.login" name="login"/>
                    <phonebook:inputField labelCode="user.password" name="password" inputType="password"/>
