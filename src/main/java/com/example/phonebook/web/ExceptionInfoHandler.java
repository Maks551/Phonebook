...
import com.example.phonebook.util.ValidationUtil;
import com.example.phonebook.util.exception.ApplicationException;
import com.example.phonebook.util.exception.ErrorInfo;
...
import static com.example.phonebook.util.exception.ErrorType.APP_ERROR;
import static com.example.phonebook.util.exception.ErrorType.DATA_ERROR;
import static com.example.phonebook.util.exception.ErrorType.VALIDATION_ERROR;
...
public class ExceptionInfoHandler {
    ...
    private static final Map<String, String> CONSTRAINS_I18N_MAP = Collections.unmodifiableMap(
            new HashMap<String, String>() {
                {
                    put("users_unique_login_idx", EXCEPTION_DUPLICATE_LOGIN);
                    put("phone_book_mobile_phone_number_idx", EXCEPTION_DUPLICATE_PHONE_NUMBER);
                }
            });
